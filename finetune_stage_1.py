...
from src.dataset.dance_image import HumanDanceDataset_fast #HumanDanceDataset
from src.dwpose import DWposeDetector
from src.models.mutual_self_attention import ReferenceAttentionControl
from src.models.pose_guider import PoseGuider # SimplePoseGuider
...
class Net(nn.Module):
    def __init__(
        ...
        # simple_pose_guider: SimplePoseGuider,
        ...
        # self.new_pose_guider = simple_pose_guider
    ...
    def forward(
        ...
        # new_pose_cond_tensor = new_pose_img.to(device="cuda")
        # new_pose_fea = self.new_pose_guider(new_pose_cond_tensor)
        
        
        # pose_fea_combined = (1-w_new_pose) * pose_fea + w_new_pose * new_pose_fea
        ...
        model_pred = self.denoising_unet(
            noisy_latents,
            timesteps,
            # pose_cond_fea=pose_fea_combined,
...
#     reference_unet = UNet2DConditionModel.from_pretrained(
#         cfg.base_model_path,).to(device="cuda")
#     denoising_unet = UNet3DConditionModel.from_pretrained_2d(
#         cfg.base_model_path,
#         "",
#         subfolder="unet",
...
#    ).to(device="cuda")
    ...
    # pose_guider = PoseGuider(conditioning_embedding_channels=320, block_out_channels=(16, 32, 96, 256)
    # ).to(device="cuda", dtype=weight_dtype)

    # simple_pose_guider = SimplePoseGuider(conditioning_embedding_channels=320, block_out_channels=(16, 32, 96, 256)
    # ).to(device="cuda", dtype=weight_dtype)
    pose_guider = PoseGuider(conditioning_embedding_channels=320, block_out_channels=(16, 32, 96, 256)
    ).to(device="cuda")
    ...
    # simple_pose_guider.load_state_dict(
    #     torch.load(config.pose_guider_path, map_location="cpu"),
    # )
...
#TODO: clarify which models are trained or not trained
    ...
    # pose_guider.requires_grad_(False)
    # simple_pose_guider.requires_grad_(True)
    ...
    #     use_simple_kps=cfg.use_simple_kps,
    #     max_frames=cfg.max_frames,
        
    # )
    train_dataset = HumanDanceDataset_fast(
        img_size=(cfg.data.train_width, cfg.data.train_height),
        img_scale=(0.9, 1.0),
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(net):
                ...
                # simple_tgt_pose_img = batch["simple_tgt_pose"]
                # simple_tgt_pose_img = simple_tgt_pose_img.unsqueeze(2) # (bs, 3, 1, 512, 512)
                ...
                # landing_step = cfg.finetune_landing_step
                # w_simple_tgt_pose = min(1., global_step / landing_step)
                    ...
                    if accelerator.is_main_process:
                        ...
                        for sample_id, sample_dict in enumerate(sample_dicts):
                            ...
                            with TemporaryDirectory() as temp_dir:
                                ...
                                print("Validation: Saving to", out_file)
                                img.save(out_file)
