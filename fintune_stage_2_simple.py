...
def log_validation(
    ...
    test_cases = [
        (
            ...
            "./configs/inference/pose_videos/pose_videos_simple/91+20mY7UJS_simple.mp4",
        ),
        (
            "./configs/inference/ref_images/anyone-2.png",
            "./configs/inference/pose_videos/pose_videos_simple/UBC_simple1.mp4",
        ),
    ]
...
def main(cfg):
    ...
    #TODO: simple pose guider!
    pose_guider.load_state_dict(
        torch.load(
            os.path.join(stage1_ckpt_dir, f"simple_pose_guider-{stage1_ckpt_step}.pth"),
            map_location="cpu",
        ),
        strict=False,
    )
