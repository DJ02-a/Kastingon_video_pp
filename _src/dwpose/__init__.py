...
def draw_pose_w_option(pose, H, W, draw_face=True, draw_hand=True, draw_body=True, wo_hand_kpts=True):
        ...
        **kwargs,
        ...
        for i in range(len(candidate_list_smoothed)):
            ...
            if simple:
                ...
                detected_map_sp = draw_pose_w_option(pose_sp, H, W, draw_hand=True, draw_face=True)
    ...
    def __call__(
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            return detected_map, body_score, detected_map_sp, input_img
